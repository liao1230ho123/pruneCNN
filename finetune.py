...
class PrunningFineTuner_VGG16:
    ...
    def train(self, optimizer = None, epoches=10):
        ...
        #torch.save(self.model, 'model(beforePrune).pkl')
    ...
    def prune(self):
        ...
        iterations = int(float(number_of_filters) / num_filters_to_prune_per_iteration) #要prune 5個iteration

        iterations = int(iterations * 4 / 5)
        ...
        torch.save(model, 'model_prunned_4of5_512.pkl')
